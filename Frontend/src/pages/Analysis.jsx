...
const Analysis = () => {
  ...
  return (
    ...
    <Row className="g-4">
        ...
        {/* ==================================================================== */}
        {/* --- ROW 1: Three Equal Cards (Weather, Trends, Risk) (lg=4 each) --- */}
        {/* ==================================================================== */}

        {/* Row 1, Column 1 (Weather Card) */}
        <Col lg={4} md={6}>
            <WeatherCard
        ...
        {/* Row 1, Column 2 (Tourism Trends Chart) */}
        <Col lg={4} md={6}>
            <TrendChart
        ...
        {/* Row 1, Column 3 (Risk Analysis Chart) */}
        <Col lg={4} md={12}>
            <RiskChart
        ...
        {/* ==================================================================================================== */}
        {/* --- ROW 2: Two Columns with 2:1 Width Ratio (Predictions lg=8, Insights+State Info lg=4) --- */}
        {/* ==================================================================================================== */}

        {/* Column 1: Future Tourism Predictions (Takes 2/3 width: lg=8) */}
            ...
            <Col lg={8} md={12}>
                <div className="card shadow h-100">
                    <div className="card-body">
                        ...
                        {/* Inner Row for the two charts (Splitting the lg=8 card horizontally) */}
                        <Row className="g-3">
                            {/* Historical and Future Predictions - Chart 1 */}
                            <Col xs={12} md={6}>
                            ...
                            {/* Category Ratings Donut Chart - Chart 2 */}
                            <Col xs={12} md={6}>
                                <div className="card bg-light h-100">
                                    <div className="card-body">
        ...
        {/* Column 2: Key Insights AND State Information (Takes 1/3 width: lg=4) */}
        <Col lg={4} md={12}>
            <div className="card shadow h-100">
                <div className="card-body">
                    ...
                    {/* 2. State Information Section (Appears directly below Key Insights) */}
                    {analysisData.state && (
                        <div className="mt-4 pt-4 border-top">
                            <h6 className="pb-2 mb-3">
                            ...
                            <Row className="g-3">
                                {analysisData.state.capital && (
                                    <Col xs={6} sm={4} lg={6}>
                                        <div className="p-2 rounded" style={{ backgroundColor: '#f8f9fa' }}>
                                            <small className="text-muted d-block"><i className="fas fa-landmark me-1"></i>Capital</small>
                                ...
                                {analysisData.state.population && (
                                    <Col xs={6} sm={4} lg={6}>
                                        <div className="p-2 rounded" style={{ backgroundColor: '#f8f9fa' }}>
                                            <small className="text-muted d-block"><i className="fas fa-users me-1"></i>Population</small>
                                ...
                                {analysisData.state.gdp_inr_crore && (
                                    <Col xs={6} sm={4} lg={6}>
                                        <div className="p-2 rounded" style={{ backgroundColor: '#f8f9fa' }}>
                                            <small className="text-muted d-block"><i className="fas fa-chart-line me-1"></i>GDP</small>
                                ...
                                {analysisData.state.literacy_rate && (
                                    <Col xs={6} sm={4} lg={6}>
                                        <div className="p-2 rounded" style={{ backgroundColor: '#f8f9fa' }}>
                                            <small className="text-muted d-block"><i className="fas fa-graduation-cap me-1"></i>Literacy Rate</small>
                                ...
                                {analysisData.state.safety_index && (
                                    <Col xs={6} sm={4} lg={6}>
                                        <div className="p-2 rounded" style={{ backgroundColor: '#f8f9fa' }}>
                                            <small className="text-muted d-block"><i className="fas fa-shield-alt me-1"></i>Safety Index</small>
                                ...
                                {analysisData.state.best_time_to_visit && (
                                    <Col xs={12}>
                                        <div className="p-2 rounded" style={{ backgroundColor: '#e8f5e9' }}>
                                            <small className="text-muted d-block"><i className="fas fa-calendar-alt me-1"></i>Best Time to Visit</small>
